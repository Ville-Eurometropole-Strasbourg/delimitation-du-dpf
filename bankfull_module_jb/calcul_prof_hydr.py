...
def CalculerProfHydr(area_trapezes_data):
    ...
    :param area_trapezes_data: aires calculées entre les courbes à chaque itération"""
    ...
    # Grouper par transect et itération, puis trouver l'indice de la ligne avec la plus grande aire négative
    ...
    largest_negative_area['profondeur_hydraulique'] = largest_negative_area['area'] / largest_negative_area['distance_between_intersections'] * -1
