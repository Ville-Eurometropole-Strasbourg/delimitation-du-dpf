...
class bankfullJB:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "bankfullJB_{}.qm".format(locale)
        )
        ...
        self.toolbar = self.iface.addToolBar("bankfullJB")
        self.toolbar.setObjectName("bankfullJB")

        # print "** INITIALIZING ClassJB"

        self.pluginIsActive = False
        # self.dockwidget = None

        self.dockwidget = bankfullJBDialog()
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("bankfullJB", message)
